        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Official Hyrox Training Club. Bespoke fitness training focused on your lifestyle and goals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/the-space" className="text-white/70 hover:text-white text-sm transition-colors">
                  The Space
                </Link>
              </li>
              <li>
                <Link to="/who-needs-us" className="text-white/70 hover:text-white text-sm transition-colors">
                  Who Needs Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/gallery" className="text-white/70 hover:text-white text-sm transition-colors">
                  Gallery
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+919999999999" className="text-white/70 hover:text-white text-sm transition-colors">
                  +91 99999 99999
                </a>
              </li>
              <li className="flex items-start gap-3">
          ...
          {/* CTA */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-4">Get Started</h4>
