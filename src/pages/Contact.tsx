    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-black text-white py-32 px-4">
        <div className="container mx-auto max-w-4xl text-center animate-fade-in">
          <div className="mb-4 text-xs uppercase tracking-widest font-semibold">Get In Touch</div>
          <h1>Contact Us</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="border-2 border-black p-12 hover:bg-black hover:text-white transition-all duration-300 group">
              ...
              <p className="text-muted-foreground group-hover:text-white/70 mb-8 leading-relaxed">
                Prefer to talk? Give us a call and we'll answer any questions you have about our programs.
              </p>
              <Button
                variant="outline"
                size="lg"
      ...
      <section className="py-24 px-4 bg-black text-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <div className="text-xs uppercase tracking-widest font-semibold mb-4">Quick Answers</div>
          ...
          <div className="space-y-8">
            <div className="border-b border-white/20 pb-8">
              ...
              <p className="text-white/70 leading-relaxed">
                Not at all! We work with people at all fitness levels, from complete beginners to experienced athletes.
                Our programs are fully customized to your current fitness level.
              </p>
            </div>
            ...
            <div className="border-b border-white/20 pb-8">
              ...
              <p className="text-white/70 leading-relaxed">
                We limit entries per hour to maintain a focused, non-crowded environment. This ensures you get the
                attention and space you need.
              </p>
            </div>

            <div className="border-b border-white/20 pb-8">
              <h3 className="mb-3">What should I bring for my first session?</h3>
              <p className="text-white/70 leading-relaxed">
                Just bring comfortable workout clothes, indoor training shoes, a water bottle, and a towel. We provide
                all equipment.
              </p>
            </div>
            ...
            <div className="border-b border-white/20 pb-8">
              ...
              <p className="text-white/70 leading-relaxed">
                While our primary focus is in-person training at our facility, we can discuss customized programs for
                your specific needs. Message us to learn more.
              </p>
            </div>
            ...
            <div className="pb-8">
              ...
              <p className="text-white/70 leading-relaxed">
                Simply send us a message on WhatsApp or give us a call. We'll discuss your goals, schedule a tour of the
                facility, and create a personalized plan for you.
              </p>
            </div>
          </div>
        </div>
