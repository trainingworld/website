import { MessageCircle, Wind, Thermometer, Users2, Dumbbell } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl animate-fade-in">
          <div className="mb-4 text-xs uppercase tracking-widest font-semibold">The Facility</div>
          <h1>The Space</h1>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="animate-fade-in-up">
              <div className="text-xs uppercase tracking-widest font-semibold mb-4">Purpose Built</div>
              <h2 className="mb-6">Designed for Performance</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Our space is purpose-built and designed for indoor sports drills and various strength and conditioning
                training formats.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                It is close to 3000sqft and has a rubberized training floor. It is HEPA filtered so the PM2.5 AQI stays
                under 30 during the harshest of weather in Delhi. It is temperature controlled so people can focus on
                their workouts without worrying about the environment.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-black text-white p-6 hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-white/70">No crowds, focused training</p>
              </div>
      ...
      <section className="py-24 px-4 bg-black text-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <div className="text-xs uppercase tracking-widest font-semibold mb-4">What You Can Do</div>
            <h2>Exercises & Training</h2>
            <p className="text-white/70 mt-4 max-w-2xl mx-auto">
              One can easily work on a variety of functional movements and exercises
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-16">
            {exercises.map((exercise, index) => (
              ...
              >
                <p className="text-sm font-semibold uppercase tracking-wide">{exercise}</p>
              </div>
            ))}
          </div>
          ...
          <div className="border-t border-white/20 pt-16">
            ...
            <div className="max-w-3xl mx-auto space-y-4 text-white/70 text-center">
              <p className="leading-relaxed">
                Training World focuses on the classical free weight method of training.
              </p>
              <p className="leading-relaxed text-lg font-semibold text-white">
                No heavy machinery. No mirrors. No loud music. No crowd.
              </p>
              <p className="leading-relaxed">
                We limit the number of entries per hour to ensure a focused, distraction-free environment.
              </p>
            </div>
          </div>
        </div>
