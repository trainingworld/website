    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl animate-fade-in">
          <div className="mb-4 text-xs uppercase tracking-widest font-semibold">Official Hyrox Training Club</div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up">
              <div className="text-xs uppercase tracking-widest font-semibold mb-4">Since 2020</div>
              <h2 className="mb-6">Your Fitness, Your Way</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Training World, started by Richard Paiva in 2020, is a bespoke fitness training platform. The aim is to
                unflinchingly focus on each person's way of life. How they are, their beliefs, philosophy on food and
                exercise.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                To be fit is a healthy means to an end. It allows time to play with your children or grandchildren, to
                climb that mountain you have on your bucket list or play football on weekends with your old school
                mates.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We work with a combination of weighted exercises, strength training and cardio variations. Training
                World has a long term perspective on fitness.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-black text-white p-8 hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-white/70">Certified training partner</p>
              </div>
              <div className="bg-muted p-8 hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-muted-foreground">All shapes & sizes welcome</p>
              </div>
              <div className="bg-muted p-8 hover:scale-105 transition-transform duration-300">
      ...
      <section className="py-24 px-4 bg-black text-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <div className="text-xs uppercase tracking-widest font-semibold mb-4">What We Do</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-white/20 p-8 hover:border-white/40 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                Classical free weight method of training. Build muscular fitness and longevity.
              </p>
            ...
            <div className="border border-white/20 p-8 hover:border-white/40 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                Official Hyrox Training Club. Prepare for the hottest fitness race format.
              </p>
              <ul className="space-y-2 text-sm text-white/70">
            ...
            <div className="border border-white/20 p-8 hover:border-white/40 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                Specialized training for marathons, triathlons and endurance events.
              </p>
              <ul className="space-y-2 text-sm text-white/70">
                <li>• Marathon prep</li>
